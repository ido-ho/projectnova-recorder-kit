...
namespace ProjectNova.RecorderKit.Tests
{
    ...
    public class ExportHeaderTests
    {
        ...
        public void AnEmptyHeader_StillCarriesEveryFieldTheSpecPrints()
        {
            ...
            foreach (var key in new[]
                     {
                         ...
                         // spec §8.3 (kit 0.9.0)
                         "configFileMaxBytes", "configMaxFiles", "audioFileMaxBytes", "stringsFileMaxBytes", "stringsMaxFiles", "uiRowsMax",
                     })
                Assert.IsTrue(caps.ContainsKey(key), "caps." + key);
            Assert.AreEqual(17, caps.Count, "caps carries exactly the seventeen the spec names (§2 + §8.3)");
            ...
            Assert.AreEqual(2147483648L, caps["artTotalMaxBytes"]!.Value<long>());

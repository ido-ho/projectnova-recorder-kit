...
namespace ProjectNova.RecorderKit
{
    ...
    public sealed class ExportTotals
    {
        ...
        public int Docs;
        /// <summary>Spec §8.6 — `strings/` entries WRITTEN.</summary>
        public int Strings;
        /// <summary>Spec §8.7 — `ui` rows WRITTEN.</summary>
        ...
        public static ExportTotals FromJson(JObject? o)
        {
            var t = new ExportTotals
            {
                ...
                Strings = ExportJson.Int(o, "strings"),
                UiElements = ExportJson.Int(o, "uiElements"),
            };
    ...
    public sealed class ExportHeader
    {
        ...
        public ExportFileSet Ui = new ExportFileSet();
        ...
        public static ExportHeader? FromJson(string json)
        {
            ...
            if (files != null)
            {
                ...
                h.Ui = ExportFileSet.FromJson(ExportJson.Obj(files, "ui"));

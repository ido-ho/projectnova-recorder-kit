...
`https://github.com/ido-ho/projectnova-recorder-kit.git#v0.9.3` and press Add — Unity writes the
...
```json
"com.projectnova.recorder-kit": "https://github.com/ido-ho/projectnova-recorder-kit.git#v0.9.3"
```

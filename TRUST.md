...
- **`self-test`** (new in 0.5.0) — an editor check you start from the web. It **records nothing and
  ...
  was taken, whether the game looks stuck on its boot scene, how many errors your game logged since
  Play was pressed and **the text of the FIRST one (up to 300 characters)**, and the git branch and
